<!-- filepath: c:\Users\Alexa\OneDrive\Escritorio\new2\student-performance-interface\resources\views\student\profile.blade.php -->
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
                                ...
                                @if(is_null($record->exam_score))
                                    ...
                                    <div class="record-form">
                                        <form action="{{ route('student.updateRecord', $record->id) }}" method="POST">
                                            ...
                                            <button type="submit" class="btn btn-custom mt-2">Actualizar Registro</button>
                                        </form>
                                    </div>
